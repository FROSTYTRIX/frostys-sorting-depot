...
public class SDJeiPlugin implements IModPlugin {
    ...
    private static final Identifier UID =
            Identifier.fromNamespaceAndPath(FrostysSortingDepot.MOD_ID, "jei_plugin");
    ...
    private record GhostTarget<I>(Rect2i area) implements IGhostIngredientHandler.Target<I> {
        ...
        public void accept(I ingredient) {
            ...
            // 26.2 has no PacketDistributor.sendToServer; push the payload as a custom-payload packet
            // through the active client connection instead.
