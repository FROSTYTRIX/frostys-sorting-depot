...
public class FilterCardMenu extends AbstractContainerMenu {
     ...
     */
    public static List<ResourceLocation> availableTags(List<ItemStack> items) {
        LinkedHashSet<ResourceLocation> tags = new LinkedHashSet<>();
        for (ItemStack stack : items) {
            stack.getTags().map(TagKey::location).forEach(tags::add);
        }
     ...
     */
    public static List<ResourceLocation> displayedTags(List<ItemStack> items, Set<ResourceLocation> selected) {
